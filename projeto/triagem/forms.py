...
class TriagemFormCreate(forms.ModelForm):
    ...
    paciente_ativo = forms.ModelChoiceField(label='Paciente *', queryset=Paciente.pacientes_ativos.all())

    class Meta:
        model = Triagem
        fields = ['responsavel', 'unidade', 'paciente_ativo', 'data_nascimento', 'altura', 'peso',
